...
valid_iter =  data.BucketIterator(dataset = valid_data,batch_size=BATCH_SIZE,device=device,repeat=False, sort_within_batch=True,shuffle=False)
...
class BiLstmCrf(nn.Module):
    def __init__(self, args):
        ...
        #     nn.Linear(self.hidden_dim, self.tag_num),
